...
(function () {
    ...
    angular.module('app', [
        ...
        .run([
            ...
            '$ionicPlatform', '$rootScope', '$stateParams', '$state', 'AuthService', 'Permission', '$window', 'PushService', 'facebookKey',

            function ($ionicPlatform, $rootScope, $stateParams, $state, AuthService, Permission, $window, PushService, facebookKey) {
